...
import 'package:catalogocarros/domain/response.dart';
...
class FirebaseService {
  ...
  Future<Response> cadastrar(String nome, String email, String senha, {File file}) async {
    try {
      // Usuario do Firebase
      final FirebaseUser fUser = (await _auth.createUserWithEmailAndPassword(email: email, password: senha)) as FirebaseUser;
